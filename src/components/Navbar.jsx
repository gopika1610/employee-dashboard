...
//   return (
//     <header className="sticky top-0 z-30 bg-white/70 backdrop-blur-2xl border-b border-slate-200 h-20 flex items-center justify-between px-6 sm:px-10 transition-all">
//       <div className="flex items-center space-x-4">
//         <button onClick={() => setSidebarOpen(true)} className="lg:hidden p-2.5 rounded-2xl bg-slate-100 text-slate-700 hover:bg-slate-200 transition-colors border border-slate-200">
//           <Menu size={22} />
//         </button>
//         <div>
...
//         </div>
//       </div>
//       <div className="flex items-center space-x-3.5 bg-slate-50 border border-slate-200 py-1.5 px-4 rounded-full shadow-sm backdrop-blur-md">
//         <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150" alt="Admin" className="w-9 h-9 rounded-full object-cover ring-2 ring-indigo-600/30" />
//         <div className="hidden sm:block text-left">
//           <p className="text-xs font-black text-slate-900 leading-tight">Admin User</p>
//           <p className="text-[10px] font-bold text-indigo-600">Super Administrator</p>
//         </div>
//       </div>
//     </header>
//   );
